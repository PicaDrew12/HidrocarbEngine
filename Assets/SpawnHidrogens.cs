...
public class SpawnHydrogens : MonoBehaviour
{
    ...
    public spawnAlchena spawnCarbonScriptAlchena;
    ...
    void Start()
    {
        ...
        //spawnCarbonScriptAlchena = GameObject.FindGameObjectWithTag("alchenaSpawner").GetComponent<spawnAlchena>();
        collisionCount = 0;
    ...
    {
        if (other.CompareTag("Conection") || other.CompareTag("piConection"))
        {
        ...
        for (int i = 0; i < iterationNumber; i++)
        {
            ...
            else //ARE 3 MAINI
            {
                ...
                if (i == 1)
                {
                    rotationZ = 90;
                    rotationX = 0;
                    if(spawnCarbonScript.carbonList[0] != null)
                    {
